/*
eddaStreamline:
The is a demo to show how to load an edda file into an OSUFlow object (loading each vector component as a sample result), then generate streamlines by OSUFlow methods and how to render the generated streamlines.
...
main(int argc, char* argv[])
{
	if (argc < 2)
	{
		printf("usage: eddaFileReaderGlStreamline filename\n");
		return 0;
	}
